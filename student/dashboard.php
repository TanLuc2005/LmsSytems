...
<head>
    ...
    <title>Students dashboard - University LMS</title>
        ...
        <div class="row flex-nowrap">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">
                        <i class="fas fa-tachometer-alt"></i> Students dashboard
                    </h1>
                                    ...
                                    <table class="table table-striped table-hover align-middle">
                                        <thead class="table-primary">
                                            <tr>
                                                ...
                                                <th><i class="fas fa-calendar-alt"></i> Enrolled</th>
                                        ...
                                        <?php foreach ($enrolled_courses as $course): ?>
                                            <tr>
                                                ...
                                                <td><i class="fas fa-chalkboard-teacher text-info"></i> 
                                                    <a href="../instructor/profile.php?id=<?php echo $course['instructor_id'] ?? $course['instructor_id']; ?>" class="text-decoration-none">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover align-middle">
                                        ...
                                        <?php foreach ($recent_assignments as $assignment): ?>
                                            <tr>
                                                <td><i class="fas fa-file-alt text-secondary"></i> <?php echo htmlspecialchars($assignment['title']); ?></td>
